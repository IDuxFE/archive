...
import type { ArchiveLoaderVue2, ArchiveLoaderVue2Options, SourceCode } from './types'
...
export function createArchiveVueLoader(options?: ArchiveLoaderVue2Options): ArchiveLoaderVue2 {
  ...
  const factoryId = `archive-vue2-loader-${factoryIdSeed++}`
