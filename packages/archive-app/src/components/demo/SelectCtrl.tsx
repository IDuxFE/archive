...
export default defineCtrComponent<'select', string | boolean | number>({
  setup({ control, controlValue, setControlValue }) {
    ...
    return () => (
      <div class="archive-app-demo__control-select">
        <IxSelect value={selectedOption.value?.label} dataSource={dataSource.value} onChange={handleChange} />
      </div>
    )
  },
})
