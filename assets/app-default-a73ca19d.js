...
function resolveRoutes(routesRecords, theme, renderers, options) {
  return [
    ...
    ...routesRecords.map((record) => {
      return {
        path: record.path,
        component: () => __vitePreload(() => import("./Page-9bdb532f.js"), true ? ["assets/Page-9bdb532f.js","assets/Demo-099c9512.js"] : void 0),
