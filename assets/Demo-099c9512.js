...
function Bn(t, e) {
  var n = typeof t;
  return e = e ?? Ln, !!e && (n == "number" || n != "symbol" && Un.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
function te(t, e, n) {
  e == "__proto__" && V ? V(t, e, {
    configurable: true,
  ...
  return defineComponent({
    ...
    setup(props) {
      ...
      const setInstanceData = debounce((value) => {
        props.instance.setData({ [props.control.key]: value ?? void 0 });
      }, 50);
  ...
  setup(props) {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        }, [createVNode("span", null, [item.label ?? item.key, createTextVNode(": ")]), item.description && createVNode(IxTooltip, {
...
const Demo = defineComponent({
  ...
  setup(props) {
    ...
    const mergedTools = computed(() => {
      var _a2;
      if ((((_a2 = props.tools) == null ? void 0 : _a2.findIndex((tool) => tool.type === "expandCode")) ?? -1) > -1) {
        return props.tools;
      }
      return [...props.tools ?? [], {
        type: "expandCode"
    ...
    const onCopy = throttle(async () => {
      var _a2, _b;
      const code = (_b = (_a2 = props.resolvedDemoItem) == null ? void 0 : _a2.sourceCodes) == null ? void 0 : _b[selectedSourceTab.value ?? 0].code;
    ...
    const renderTool = (tool) => {
      ...
      if (tool.type === "copyCode") {
        return createVNode(DemoToolComp, {
          "tooltip": tool.tooltip ?? copyTitle.value,
          "onClick": onCopy
        }, {
...
function mergeDemoControls(item) {
  ...
  return ((_a2 = demoProps2 == null ? void 0 : demoProps2.map((prop) => {
    var _a3;
    const control = (_a3 = item.controls) == null ? void 0 : _a3[prop.key];
    if (!control) {
